...
const CreateAppointment: React.FC = () => {
  ...
  /** Recupera a lista de providers disponíveis */
  useEffect(() => {
    api.get('providers').then((response) => {
      setProviders(response.data);
    });
  }, []);
  /** Recupera os horários disponíveis do provider selecionado */
  useEffect(() => {
    api
  ...
  const handleCreateAppointment = useCallback(async () => {
    try {
      ...
      // date.setHours(selectedHour) está jogando o horário 1 hora pra cima
